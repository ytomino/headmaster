...
let known_uninterpretable_macros = make_setmap [
	...
	"ctype.h", [
		"__isalnum_l"; (* linux / accessing element of untyped parameter *)
		"__isalpha_l"; (* linux / accessing element of untyped parameter *)
		"__isblank_l"; (* linux / accessing element of untyped parameter *)
		"__iscntrl_l"; (* linux / accessing element of untyped parameter *)
		"__isctype_l"; (* linux / accessing element of untyped parameter *)
		"__isdigit_l"; (* linux / accessing element of untyped parameter *)
		"__isgraph_l"; (* linux / accessing element of untyped parameter *)
		"__islower_l"; (* linux / accessing element of untyped parameter *)
		"__isprint_l"; (* linux / accessing element of untyped parameter *)
		"__ispunct_l"; (* linux / accessing element of untyped parameter *)
		"__isspace_l"; (* linux / accessing element of untyped parameter *)
		"__isupper_l"; (* linux / accessing element of untyped parameter *)
		"__isxdigit_l"]; (* linux / accessing element of untyped parameter *)
	"dirent.h", [
	...
	"libio.h", [
		"_IO_feof_unlocked"; (* linux / accessing element of untyped parameter *)
		"_IO_ferror_unlocked"; (* linux / accessing element of untyped parameter *)
		"_IO_getc_unlocked"; (* linux / accessing element of untyped parameter *)
		"_IO_peekc"; (* linux / accessing element of untyped parameter *)
		"_IO_peekc_unlocked"; (* linux / accessing element of untyped parameter *)
		"_IO_PENDING_OUTPUT_COUNT"; (* linux / accessing element of untyped parameter *)
		"_IO_putc_unlocked"]; (* linux / accessing element of untyped parameter *)
	"mpc.h", [
	...
	"oleauto.h", [
		...
		"V_I1REF"; (* mingw-w64 / accessing element of untyped parameter *)
		...
		"V_RECORD"; (* mingw-w64 / accessing element of untyped parameter *)
		"V_RECORDINFO"; (* mingw-w64 / accessing element of untyped parameter *)
		...
		"V_UI2REF"; (* mingw-w64 / accessing element of untyped parameter *)
	...
	"propidl.h", [
		"PropVariantInit"]; (* mingw-w64 / sizeof untyped parameter *)
	"rpcasync.h", [
		"RpcAsyncGetCallHandle"]; (* mingw-w64 / accessing element of untyped parameter *)
	"rpcndr.h", [
	...
	"select.h", [
		"__FDS_BITS"; (* linux / accessing element of untyped parameter *)
		"FD_CLR"; (* darwin9 / accessing element of untyped parameter *)
		"__FD_CLR"; (* linux / accessing element of untyped parameter *)
		"FD_ISSET"; (* freebsd7 / accessing element of untyped parameter *)
		"__FD_ISSET"; (* linux / accessing element of untyped parameter *)
		"FD_SET"; (* darwin9 / accessing element of untyped parameter *)
		"__FD_SET"; (* linux / accessing element of untyped parameter *)
		"FD_ZERO"; (* linux / accessing element of untyped parameter *)
		"__FD_ZERO"]; (* linux / accessing element of untyped parameter *)
	"socket.h", [
	...
	"winioctl.h", [
		"DiskGeometryGetDetect"; (* darwin9 / accessing element of untyped parameter *)
		"DiskGeometryGetPartition"]; (* darwin9 / accessing element of untyped parameter *)
	"winsock2.h", [
		"timerclear"; (* mingw32 / accessing element of untyped parameter *)
		"timerisset"]; (* mingw32 / accessing element of untyped parameter *)
	"winuser.h", [
		"NEXTRAWINPUTBLOCK"; (* mingw-w64 / accessing element of untyped parameter *)
